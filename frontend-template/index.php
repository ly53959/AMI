			...
			<!-- Content Row -->
				<div class="col-md-4 mb-4">
					<div class="card h-100">
						<a title="<?php echo $article['title'];?>" href="<?php echo SITE_URL.'/'.$article['categ_slug'].'/'.$article['id'].'-'.$article['slug'];?>"><img class="card-img-top" src="<?php echo UPLOADS_DIR.'/small/'.$article['image'];?>" alt="$article['title']"></a>
						<div class="card-body">
