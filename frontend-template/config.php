...
/*==============================================
|| ############################################# 
|| Copyright PikePHP - www.pikephp.com
|| ############################################# 
==============================================*/

define('SITE_URL', 'https://www.pikephp.com/pike-admin-frontend'); // URL where front end template is inslatted. Without ending slash
define('UPLOADS_DIR', 'https://www.pikephp.com/admindemo/uploads'); // URL for uploads folder. Without ending slash
...
define('DB_NAME', 'pike'); // Database name ## Datenbank Name
