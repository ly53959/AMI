<!-- top bar navigation -->
	<div class="headerbar">
        ...
        <div class="headerbar-left">
			<a href="index.php" class="logo"><img src="<?php echo ADMIN_URL;?>/assets/images/logo.png" /> <span>Xie Lin</span></a>
        </div>
        ...
        <nav class="navbar-custom">
                    ...
                    <ul class="list-inline menu-left mb-0">
                        ...
                        <div class="logo">
                            <strong class="text-warning">Advanced metering infrastructure system</strong>
                        </div>                        
                    </ul>
